    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-7">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-7">
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="bg-white border border-white/20 px-4 py-3 text-[15px] font-light text-[#001f3f] placeholder:text-[#001f3f]/35 focus:outline-none focus:border-[#001f3f]/40 transition-colors duration-200"
          />
        </div>
        <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          <select
            id="inquiry"
            name="inquiry"
            className="w-full bg-white border border-white/20 px-4 py-3 text-[15px] font-light text-[#001f3f] focus:outline-none focus:border-[#001f3f]/40 transition-colors duration-200 appearance-none cursor-pointer"
          >
            <option value="chartering" className="bg-white text-[#001f3f]">Chartering</option>
            <option value="fleet-position" className="bg-white text-[#001f3f]">Fleet Position</option>
            <option value="sale-purchase" className="bg-white text-[#001f3f]">Sale &amp; Purchase</option>
            <option value="general" className="bg-white text-[#001f3f]">General Enquiry</option>
            <option value="media" className="bg-white text-[#001f3f]">Media Relations</option>
          </select>
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          ...
          className="bg-white border border-white/20 px-4 py-3 text-[15px] font-light text-[#001f3f] placeholder:text-[#001f3f]/35 focus:outline-none focus:border-[#001f3f]/40 transition-colors duration-200 resize-none"
        />
      </div>
